...
public class GeneratorProperties {
	...
	String PROPERTIES_FILE_NAMES[] = new String[] { "generator.properties", "generator.xml" };

	static PropertiesHelper propertiesHelper = new PropertiesHelper(new Properties(), true);

	public GeneratorProperties(String[] PROPERTIES_FILE_NAMES) {
		if (null != PROPERTIES_FILE_NAMES) {
			this.PROPERTIES_FILE_NAMES = PROPERTIES_FILE_NAMES;
		}
		reload();
	}
